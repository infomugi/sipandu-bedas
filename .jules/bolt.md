...
## 2026-04-08 - Concurrent Queries
**Learning:** Sequential database queries for independent data (like parent and children) increase network I/O latency unnecessarily.
**Action:** Use Promise.all to batch independent queries concurrently.
