...
app.get('/api/keluarga/:keluarga_id/anggota', async (req, res) => {
    try {
        ...
        // inside a Common Table Expression (CTE) to prevent redundant computations across SELECT and CASE clauses.
        const { rows } = await pool.query(
            `WITH computed_age AS (
               SELECT *,
             ...
             FROM computed_age ORDER BY status_keluarga`,
