...
app.get('/api/keluarga/:id', async (req, res) => {
    try {
        // ⚡ Bolt Optimization: Batch independent database queries concurrently using Promise.all
        // to reduce network I/O latency instead of awaiting them sequentially.
