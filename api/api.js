...
const comparePassword = (password, storedHash) => {
    return new Promise((resolve, reject) => {
        ...
        if (!storedHash || typeof storedHash !== 'string') {
            return resolve({ isValid: false, needsUpgrade: false });
        }
...
app.post('/api/auth/login', async (req, res) => {
    try {
        ...
        // 🛡️ Sentinel: Fix authentication bypass and plaintext passwords
...
app.post('/api/auth/register', async (req, res) => {
    try {
        ...
        // 🛡️ Sentinel: Hash password instead of storing plaintext
...
app.put('/api/profil/:id/password', async (req, res) => {
    try {
        ...
        // 🛡️ Sentinel: Secure password change implementation
